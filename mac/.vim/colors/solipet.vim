...
hi Special      gui=NONE guifg=OrangeRed2 guibg=NONE
hi String       gui=NONE guifg=MediumSlateBlue guibg=NONE
...
if &background == "dark"
  ...
  hi Statement    gui=bold guifg=DarkGoldenrod4 guibg=NONE
  ...
  hi Boolean      gui=bold guifg=DarkOrange guibg=NONE
  hi Comment      gui=italic guifg=Gray90 guibg=NONE
  ...
  hi Statement    gui=bold guifg=DarkGoldenrod3 guibg=NONE
